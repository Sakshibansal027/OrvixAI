...
async function insertMissingDemoRecords(model: any, idField: string, records: Array<Record<string, any>>): Promise<void> {
...
async function seed(): Promise<void> {
  ...
  await insertMissingDemoRecords(Customer, 'customerId', [
  ...
  await insertMissingDemoRecords(Order, 'orderId', [
  ...
  await insertMissingDemoRecords(Payment, 'paymentId', [
  ...
  await insertMissingDemoRecords(Refund, 'refundId', [
  ...
  await insertMissingDemoRecords(SupportTicket, 'ticketId', [
  ...
  await insertMissingDemoRecords(CompanyPolicy, 'policyId', [
